  ...
  return (
    <>
            ...
            <div className="flex items-center gap-2 lg:gap-4 mr-4 lg:mr-9">
              ...
              >
                <Link href="/cart" className="relative m-2">
                  <FontAwesomeIcon 
                    className={`fa-solid fa-cart-shopping text-2xl w-8 ${scrolled ? "bgg" : "text-white"} shadow-2xl shadow-black`} 
                    icon={faCartShopping}  
                  />
                  {cartCount > 0 && (
                    <motion.span 
              ...
              >
                <Link href="https://wa.me/+201211661802" className="m-2">
                  <FontAwesomeIcon 
                    className={`fa-brands fa-whatsapp text-3xl w-9 ${scrolled ? "bgg" : "text-white"} shadow-2xl shadow-black`} 
                    icon={faWhatsapp} 
                  />
                </Link>
              </motion.div>
      ...
      <motion.section
        ...
        className="w-full min-h-screen bg-[url('/bg.png')] bg-fixed bg-cover bg-center flex items-center md:items-start justify-center md:justify-end"
      >
        <motion.div 
